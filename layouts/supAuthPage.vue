<template>
  <a-layout id="components-layout-demo-responsive" style="height: 100vh">
    ...
    >
      <div>
        ...
        <div>
          ...
          <a-row type="flex" justify="center" class="usertype">
            ...
            <span class="username">{{ supervisor.email }}</span>
          </a-row>
          <a-row type="flex" justify="center" class="usertype">
            <span style="margin:0 10px"> User ID: </span>
            <span class="username">{{ supervisor.id }}</span>
          </a-row>
        </div>
      </div>
      <a-menu
      ...
      >
        <a-menu-item key="1" @click="gotoPage('/supervisor/my-students')">
          <img :src="icon1" class="navlink" />
          <span class="nav-text username">My Students</span>
        </a-menu-item>

        <a-menu-item key="2" @click="gotoPage('/supervisor/profile')">
          <img :src="icon2" class="navlink" />
          <span class="nav-text username">Supervisor’s Profile</span>
        </a-menu-item>

        <a-menu-item key="3" @click="gotoPage('/supervisor/student-logbook')">
          <img :src="icon3" class="navlink" />
          <span class="nav-text username">Student Logbook</span>
        </a-menu-item>

        <a-menu-item key="4" @click="gotoPage">
          <img :src="icon4" class="navlink" />
          <span class="nav-text username">Settings</span>
        </a-menu-item>
      </a-menu>
